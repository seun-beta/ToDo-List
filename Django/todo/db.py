...
class SeedData:
    ...
    drop_table = "DROP TABLE IF EXISTS todo_task;"
    create_table = """CREATE TABLE todo_task (Id INTEGER PRIMARY KEY,
                Task varchar(100) NOT NULL,
                Description varchar(2048) NOT NULL);"""

    insert_task1 = """INSERT INTO todo_task (Task, Description) VALUES
                ('Take the first 2 courses of Python 4 Everybody by Charles
                    Severance for a good intro to Python',
                'This is the first description');"""
    insert_task2 = """INSERT INTO todo_taskcpde  (Task, Description) VALUES
    ...
    def connect_data(self):
        ...
        cur.executescript(
            f"""
            {SeedData.drop_table} {SeedData.create_table}
            {SeedData.insert_task1} {SeedData.insert_task2}
            {SeedData.insert_task3} {SeedData.insert_task4}
        """
        )
        connection.commit()
        cur.close()
